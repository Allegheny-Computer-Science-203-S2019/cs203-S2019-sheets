...
implemented in the aspect-oriented style and observe how the plugins enable you
...
\section*{Preparing and Running a Plugin-Based Python Program}
...
%
Next, you should notice that this Python program contains ``plugins'' that are
``installed'' into the main program. What are the benefits associated with using
the aspect-oriented style to insert the profiling statements into the program?
%
