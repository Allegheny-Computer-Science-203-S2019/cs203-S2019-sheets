...
that help you to time the execution of the program. Which functions in this
programm take the most time to execute? How does the execution time of a
function vary depending on the provided input? What are the benefits associated
with using the aspect-oriented style to introduce the profiling statements?
%
...
parameterized tests, or why the aspect-oriented system is designed in this way.
