...
%
You are also expected to find and read all of the online resources
that you need to complete this assignment.
...
to take steps to refactor the Python program and tests to avoid those concerns,
