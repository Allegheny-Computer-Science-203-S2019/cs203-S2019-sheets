...
teaching assistants and the course instructor. You will continue to practice to
implementing and running a Python program and also using the Pipenv tool and the
...
will also start to look for and fix ``red flags'' in your system's design (e.g.,
``repetition'' and ``vague name''). Finally, you will continue to both document
deficiencies of the ``cookbook program style'' and to automated its coverage
testing with Pytest.
