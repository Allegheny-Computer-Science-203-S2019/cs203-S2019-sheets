...
\newcommand{\mainprogram}{\lstinline{compute_tf_pipline.py}}
\newcommand{\mainprogramsource}{\lstinline{termfrequency/compute_tf_pipline.py}}

\newcommand{\testprogram}{\lstinline{test_compute_tf_pipline.py}}
\newcommand{\testprogramsource}{\lstinline{tests/test_compute_tf_pipline.py}}
...
completing the project. Along with practicing how to use Pytest plugins, will
refactor the source code of a Python program implemented in the pipeline style
and then use parameterized testing to establish a confidence in the program's
correctness.
...
suite that currently contains two test. Following the strategy of this test and
