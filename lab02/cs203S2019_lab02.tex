...
\item Available for download in the GitHub repository at
  \url{https://github.com/GatorEducator/gatorgrouper}, a completed, high-quality
  group formation tool that is written in Python and in production use.
