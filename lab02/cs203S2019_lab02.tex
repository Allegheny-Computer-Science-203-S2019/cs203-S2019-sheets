...
your class to design, implement, test, deploy, and enhance a group formation
tool in the Python programming language.
%
You can learn more about this tool, called GatorGrouper, by visiting the
following web site: \url{https://github.com/GatorEducator/gatorgrouper}. After
reading the current description of GatorGrouper, you will see that it was
developed by students who previously took this course.
