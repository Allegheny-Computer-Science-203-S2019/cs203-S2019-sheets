...
%
Along with using GitHub features like the issue tracker and the reviewing pull
requests, in this assignment you will learn how to use Markdown to complete
...
technical leaders, and the course instructor. Ultimately, students will work
together to write (i) an assessment guide to evaluate a team member's mastery of
technical and professional skills and (ii) a code of conduct governing how all
team members will interact during the completion of software products.
