...
\newcommand{\labtitle}[1]
{
  \begin{center}
    \begin{center}
      \bf
      CMPSC 203\\Introduction to Computer Science I\\
      Spring 2019\\
      \medskip
    \end{center}
    \bf
...
files and the \command{src/} directory. Make sure that you can find finding your
``home base'' for this practical assignment! Please see the instructor if you
are stuck on getting started.

Now, study the documentation in the provided source code and documentation to
...
all of the source code from Chapter 3 of the course textbook. You will need to
add in the appropriate source code and documentation to ensure that the Python
program passes all of the checks and produces the correct output.
...
assignments. To automatically check your Python source code you can get started
with the use of the GatorGrader tool, typing the command \gatorgraderstart{} in
