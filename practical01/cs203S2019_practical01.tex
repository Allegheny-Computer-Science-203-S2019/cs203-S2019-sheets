...
your terminal window. If you do have mistakes in your assignment, then you will
need to review GatorGrader's output, find the mistake, and try to fix it. Also,
...
successful. If you notice that transferring your Java source code to GitHub did
