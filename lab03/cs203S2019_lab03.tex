...
\section*{Developing and Releasing a Pytest Plugin}
...
a multiple teams to create and release a software product.
%
For this laboratory assignment, your task is to collaborate with the members of
your class to design, implement, test, deploy, and maintain a suite of Pytest
plugins that are implemented in the Python programming language.
%



That is, everyone is responsible for working
...
\begin{itemize}
  ...
  \item {\bf Week One}: Along with deciding which Pytest plugins you will
